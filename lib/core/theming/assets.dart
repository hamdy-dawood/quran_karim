class ImageManager {
  ...
  static const String basmalahImg = "${baseImages}basmalah.png";
  static const String compassImg = "${baseImages}compass.png";
  static const String designImg = "${baseImages}design.png";
  static const String kaabaImg = "${baseImages}kaaba.png";
  static const String quranLogoImg = "${baseImages}quran_logo.png";
  static const String bedImg = "${baseImages}bed.png";
  static const String eveningImg = "${baseImages}evening.png";
  static const String morningImg = "${baseImages}morning.png";
